        ...
        exports.create = function (options) {
            ...
            _input.change(function (e) {
                ...
                toDataUrl(function (src) {
                    // Add invisible canvas of prefered height and width
                    ...
                    image.onload = function() {
                        ...
                        // Read image sizes, use this to scale it to the prefered size
                        ...
                        ctx.drawImage(image, -(width - options.width) / 2, -(height - options.height) / 2, width, height);
